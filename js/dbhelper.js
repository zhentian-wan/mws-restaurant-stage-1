...
class DBHelper {   // eslint-disable-line no-unused-vars
  ...
  static getSourcesForRestaurant(restaurant) {
      ...
      console.log(DBHelper.imageSrcset(filename,ext));

      let jpeg = document.createElement('SOURCE');
      jpeg.setAttribute('data-srcset',DBHelper.imageUrlForRestaurant(filename,ext));

      let webp = document.createElement('SOURCE');
      webp.setAttribute('data-srcset',DBHelper.imageUrlForRestaurant(filename,'webp'));
      webp.setAttribute('type','image/webp');

      let fallback = document.createElement('img');
      fallback.setAttribute('data-srcset',DBHelper.imageUrlForRestaurant(filename,ext));
